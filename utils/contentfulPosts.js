...
export async function fetchRecentPosts(limit) {
  ...
  const recentPosts = response.data[collection].items ? response.data[collection].items : []
...
async function getPaginatedBlogPosts(page) {
  ...
  const posts = response.data[collection].items ? response.data[collection].items : []
...
export async function fetchPost(slug) {
  ...
  const response = await callContentful(query)
  const pageContent = response.data[collection].items ? response.data[collection].items : []
