  ...
  return (
    <div className="mt-6 flex justify-center lg:justify-start w-full">
      <input
        ...
        type="text"
        className="border border-gray-500 py-2 px-4 h-12 w-full rounded border-r-0 rounded-r-none focus:outline-none"
      />
      <button
        ...
        focus:outline-none bg-palette-primary hover:bg-palette-dark font-semibold text-white"
